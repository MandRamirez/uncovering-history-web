...
export default function DashboardPage() {
  ...
  const handleLogout = () => {
    if (typeof window !== "undefined") {
      localStorage.removeItem("uh_logged_in");
      router.push("/");
    }
  };
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              className="rounded-full border border-red-400 bg-red-500 px-4 py-1.5 text-xs font-semibold text-white shadow hover:bg-red-400"
            >
              Sair
            </button>
          </div>
