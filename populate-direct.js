// ============================================
// SCRIPT PARA COPIAR Y PEGAR EN MONGOSH
// ============================================
// Simplemente copia todo este contenido y pégalo en la consola de mongosh
...
// Array con los 5 puntos de interés
const points = [
  {
    recordState: 'FILLED',
    isDeleted: false,
    ...
    createdAt: now,
    updatedAt: now,
    location: { x: -55.53167, y: -30.89167 },
  ...
  },
  {
    ...
    createdAt: now,
    updatedAt: now,
    location: { x: -55.54056, y: -30.89472 },
  ...
  },
  {
    ...
    createdAt: now,
    updatedAt: now,
    location: { x: -55.53278, y: -30.88889 },
  ...
  },
  {
    ...
    createdAt: now,
    updatedAt: now,
    location: { x: -55.53972, y: -30.90083 },
  ...
  },
  {
    ...
    createdAt: now,
    updatedAt: now,
    location: { x: -55.52889, y: -30.89333 },
...
// Insertar los puntos
print('🚀 Insertando puntos de interés...\n');
...
print('\n✨ Proceso completado!');
print(`Insertados: ${insertedCount} | Errores: ${errorCount}`);
