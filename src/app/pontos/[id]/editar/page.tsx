...
export default function EditarPontoPage({ params }: PageProps) {
  ...
  function toggleArrayValue(arr: string[], value: string, setter: (arr: string[]) => void) {
      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-4">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="space-y-1">
                ...
                >
                  <option key="tipo-empty" value="">Selecione um tipo (opcional)</option>
                  {tipos.map((t) => (
              ...
              <div className="space-y-1">
                ...
                >
                  <option key="parent-empty" value="">Nenhum (ponto independente)</option>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              <label className="text-xs font-medium text-zinc-200">Endereço</label>
              <input
                className="w-full rounded-xl border border-zinc-700 bg-zinc-950 px-3 py-1.5 text-sm text-zinc-100 outline-none focus:border-emerald-400"
                value={address}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-xs font-medium text-zinc-200">Status</label>
              <div className="flex flex-wrap gap-2">
                {['Preservado', 'Em restauração', 'Deteriorado', 'Demolido', 'Tombado'].map((item) => (
                  <button
                    key={item}
                    type="button"
            ...
            {/* Histórica */}
            <div className="space-y-2">
              <label className="text-xs font-medium text-zinc-200">Relevância Histórica</label>
              <div className="flex flex-wrap gap-2">
                {['Colonial', 'Imperial', 'Republicana', 'Guerra', 'Revolução', 'Cultura', 'Política'].map((item) => (
                  <button
                    key={item}
                    type="button"
            ...
            {/* Arte */}
            <div className="space-y-2">
              <label className="text-xs font-medium text-zinc-200">Arte e Arquitetura</label>
              <div className="flex flex-wrap gap-2">
                {['Barroco', 'Neoclássico', 'Modernista', 'Art Déco', 'Contemporâneo', 'Indígena'].map((item) => (
                  <button
                    key={item}
                    type="button"
            ...
            {/* Biológica */}
            <div className="space-y-2">
              <label className="text-xs font-medium text-zinc-200">Relevância Biológica/Natural</label>
              <div className="flex flex-wrap gap-2">
                {['Árvore centenária', 'Jardim histórico', 'Biodiversidade', 'Espécie nativa', 'Reserva'].map((item) => (
                  <button
                    key={item}
                    type="button"
            ...
            {/* Química */}
            <div className="space-y-2">
              <label className="text-xs font-medium text-zinc-200">Relevância Química/Industrial</label>
              <div className="flex flex-wrap gap-2">
                {['Indústria histórica', 'Mineração', 'Farmacêutica', 'Química', 'Produção artesanal'].map((item) => (
                  <button
                    key={item}
                    type="button"
